...
local function showKeyGui(onSuccess)
    ...
    kframe.Size = UDim2.new(0, 380, 0, 260)
    kframe.Position = UDim2.new(0.5, -190, 0.5, -130)
    ...
    hwidBtn.Size = UDim2.new(1, -40, 0, 26)
    hwidBtn.Position = UDim2.new(0, 20, 0, 184)
    hwidBtn.BackgroundColor3 = Color3.fromRGB(28, 28, 36)
    hwidBtn.BorderSizePixel = 0
    hwidBtn.Text = "Copy HWID"
    hwidBtn.TextColor3 = Color3.fromRGB(180, 180, 200)
    hwidBtn.TextSize = 11
    hwidBtn.Font = Enum.Font.Gotham
    hwidBtn.Parent = kframe

    local hCorner = Instance.new("UICorner")
    hCorner.CornerRadius = UDim.new(0, 6)
    hCorner.Parent = hwidBtn
